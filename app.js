...
const sessionOptions = {
  ...
  cookie: {
    ...
    maxAge: 1000 * 60 * 60 * 24 * 7, // ✅ Fixed: Changed to 7 days to match expires
    httpOnly: true
  },
};
...
// ✅ THEN res.locals middleware (only ONCE, after passport)
...
// app.listen(8080,()=>{
//   console.log("server is lestening to port 8008");
//   });
